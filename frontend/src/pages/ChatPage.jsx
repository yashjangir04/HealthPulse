...
const ChatPage = () => {
  ...
  const speakText = useCallback(async (text, msgId) => {
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_VOICE_ROUTE}/api/tts`, {
        method: "POST",
  ...
  const handleToggleMic = async () => {
    ...
    try {
      ...
      mediaRecorder.onstop = async () => {
        ...
        try {
          const res = await fetch(`${import.meta.env.VITE_VOICE_ROUTE}/api/voice-command`, { method: "POST", body: form });
