...
const DoctorView = () => {
  ...
  <div className="px-8 py-4 border-b border-gray-100">
    <span 
      className="text-xl font-light text-slate-400 tracking-tight"
  ...
  <div className="px-8 py-6 space-y-4">
    ...
    <div>
      ...
      <p className="text-slate-700 font-semibold">Apollo</p>
    </div>

    <div>
      <p className="text-slate-400 text-sm">Consultation Fee</p>
      <p className="text-slate-700 font-semibold">₹500</p>
    </div>

    <div>
      <p className="text-slate-400 text-sm">Available Timings</p>
      <p className="text-slate-700 font-semibold">10 AM - 5 PM</p>
    </div>
...
<section className="bg-white rounded-[2.5rem] shadow-xl border-[2px] border-[#1B80FD]/10 overflow-hidden flex-grow flex flex-col min-h-[200px]">
  ...
  <div className="px-8 py-6 space-y-4">
    ...
    <div>
      ...
      <p className="text-slate-700 font-semibold">Cardiologist</p>
    </div>

    <div>
      <p className="text-slate-400 text-sm">Experience</p>
      <p className="text-slate-700 font-semibold">8 years</p>
    </div>

    <div>
      <p className="text-slate-400 text-sm">Qualification</p>
      <p className="text-slate-700 font-semibold">MBBS, MD</p>
    </div>

    <div>
      <p className="text-slate-400 text-sm">License No</p>
      <p className="text-slate-700 font-semibold">XXXXX</p>
    </div>
